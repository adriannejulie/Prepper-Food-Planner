...
function Recipe({ aRecipe, viewNewRecipe, isActiveRecipe}) {        
    return (
        <button onClick={() => {viewNewRecipe(aRecipe)}} className={isActiveRecipe ? "users-recipe users-recipe-active-color" : "users-recipe users-recipe-default-color"}>
            ...
            <div className={isActiveRecipe ? "recipe-time-calories recipe-time-calories-active" : "recipe-time-calories recipe-time-calories-default"}><MdHourglassTop className={isActiveRecipe ? "recipe-icon-styling recipe-icon-active-color" : "recipe-icon-styling recipe-icon-default-color"}/><div>{aRecipe.duration} Minutes</div><MdHourglassTop className="hide-icon"/></div>
